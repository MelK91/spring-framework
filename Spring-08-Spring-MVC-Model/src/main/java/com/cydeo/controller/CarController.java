...
public class CarController {
    ...
    @RequestMapping("/info")  //localhost:8080/car/info?make=Honda&year=2005 (I want to print honda in the console)
    public String carInfo(@RequestParam String make, @RequestParam Integer year, Model model) {
        model.addAttribute("make",make);
        model.addAttribute("year",year);
        return "/car/car-info";
    }
    @RequestMapping("/info2")  //localhost:8080/car/info?make=Honda&year=2005 (I want to print honda in the console)
